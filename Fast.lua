...
--------------------------------
os.execute('cp -a ./source/. ./@'..userbot..' && cd @'..userbot..' &&chmod +x * && screen -m -d -S '..userbot..' python3.8 -m AnonX')
sleep(3)
----------------------------------
Redis:del(Fast..data.sender_id.user_id.."bottoken")
Redis:del(Fast..data.sender_id.user_id.."botuser")
...
os.execute('cp -a ./update/. ./'..folder..' && cd '..folder..' &&chmod +x * && screen -X -S '..folder:gsub("@","")..' quit && screen -d -m -S '..folder:gsub("@","")..' python3.8 -m AnonX')
r = r+1
end
end
